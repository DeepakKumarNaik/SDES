...
if(mysqli_query($connection,'drop table student')){
echo '<center><h2>Successfully Table Deleted !</h2></center>';
header('refresh:3,url=index.php');	
}

else{
	
echo '<center><h2>Problem with deleting the table !</h2></center>';		
}
